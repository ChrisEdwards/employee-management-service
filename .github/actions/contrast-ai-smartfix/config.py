...
# .github/contrast-ai-smartfix/config.py
import os
import sys
import json
...
MAX_BUILD_ATTEMPTS = get_env_var("MAX_BUILD_ATTEMPTS", required=False, default="6")
...
# --- Paths ---
# Use the directory of the config script itself to find the .github folder, then go up to repo root
...
debug_print(f"Attempt Writing Security Test: {ATTEMPT_WRITING_SECURITY_TEST}")
