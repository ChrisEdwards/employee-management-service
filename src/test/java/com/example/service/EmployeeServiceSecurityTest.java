...
public class EmployeeServiceSecurityTest {
  ...
  public void testIsCommandAllowed() throws Exception {
    ...
    Method isCommandAllowedMethod =
        EmployeeService.class.getDeclaredMethod("isCommandAllowed", String.class);
    ...
    assertThat((Boolean) isCommandAllowedMethod.invoke(employeeService, "cat /etc/passwd"))
        .isFalse();
    assertThat((Boolean) isCommandAllowedMethod.invoke(employeeService, "ls; rm -rf /")).isFalse();
    assertThat((Boolean) isCommandAllowedMethod.invoke(employeeService, "ls | grep java"))
        .isFalse();
  }
}
